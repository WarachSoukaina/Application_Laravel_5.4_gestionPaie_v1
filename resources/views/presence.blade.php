...
<div class="modal fade in" id="mymod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <div class="loginmodal-container">
          ...
          <br>
          <form method="POST" action="{{ url('/default') }}">
                        {{ csrf_field() }}
            <label>Nombre de jours par default :</label>
          <input type="number" name="joursdef" class="form-control">
            <label>Nombre de jours férie :</label>          
          <input type="number" name="jf" class="form-control"><br>
          <button type="submit"  class="btn btn-info btn-lg"> créer la liste</button>
          </form>
